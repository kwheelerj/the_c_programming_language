...
printf("Conclusion:\n");
printf("  int op float will PROMOTE the answer to a float;\n");
printf("\tbe prepared to store it or print it as such.\n");
printf("  If you print %%d for a float-sized value,\n");
printf("\tthen the decimal places (float part) will be truncated.\n");
